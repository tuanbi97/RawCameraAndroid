...
public class Camera2RawFragment extends Fragment
    ...
    //
    private static int countSavedImage = 0;
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureStarted(CameraCaptureSession session, CaptureRequest request,
            ...
            //create file
            String currentDateTime = getActivity().getIntent().getStringExtra("uniquename");
            //String currentDateTime = generateTimestamp();
            String captureType = rawBuilder.captureType ? "flash": "noflash";

            File rawFile = new File(Environment.
                    getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM),
                    "RAW_" + currentDateTime + "_" + captureType + ".dng");

            captureType = jpegBuilder.captureType ? "flash": "noflash";

            File jpegFile = new File(Environment.
                    getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM),
                    "JPEG_" + currentDateTime + "_" + captureType + ".jpg");

            //Write Orietntation
//            File orientationFile = new File(Environment.
//                    getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM),
//                    "ORI_" + currentDateTime + ".txt");
//            FileWriter writer = null;
//            try {
//                writer = new FileWriter(orientationFile);
//                writer.write(Integer.toString(sensorReader.eulerAngles[0]) + " " +
//                        Integer.toString(sensorReader.eulerAngles[1]) + " " +
//                        Integer.toString(sensorReader.eulerAngles[2]));
//                writer.flush();
//                writer.close();
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        sensorReader = new SensorReader(getActivity());
        sensorReader.start();
    ...
    public void preTakePicture(){
        ...
        new CountDownTimer(2000, 1000){
            ...
            public void onTick(long l) {
                long t = l/1000;
                String te = Long.toString(t);
                TextView cd = (TextView) getView().findViewById(R.id.countdown);
                cd.setText(te);
            }
    ...
    private boolean setUpCameraOutputs() {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                //Log.d("Camera Characteristics", characteristics.get(CameraCharacteristics.FLASH_INFO_AVAILABLE).toString());
...
//            }
    ...
    private void createCameraPreviewSessionLocked() {
        try {
            ...
            //Surface surface = new Surface(new SurfaceTexture(123123));
    ...
    private void captureStillPictureLocked() {
        try {
            ...
            jpegBuilder.captureType = isFlashOn;
            mJpegResultQueue.put((int) request.getTag(), jpegBuilder);
            rawBuilder.captureType = isFlashOn;
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            if (success) {
                ...
                countSavedImage += 1;
                //Log.d("countSavedImages:", Integer.toString(countSavedImage));
            }
        }
